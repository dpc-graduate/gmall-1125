...
public class SpuController {
    ...
    @PostMapping("page")
    @ApiOperation("分页查询")
    public ResponseVo<List<SpuEntity>> querySpuByPageFeign(@RequestBody PageParamVo paramVo){
        PageResultVo pageResultVo = spuService.queryPage(paramVo);
    ...
    public ResponseVo<PageResultVo> querySpuPage(@PathVariable("categoryId") long categoryId, PageParamVo pageParamVo){
        PageResultVo resultVo= this.spuService.queryPage(categoryId,pageParamVo);
