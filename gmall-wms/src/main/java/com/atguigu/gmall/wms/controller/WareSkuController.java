...
public class WareSkuController {
    ...
    public ResponseVo<List<WareSkuEntity>> queryWareBySkuId(@PathVariable("skuId") Long id) {
        return ResponseVo.ok(this.wareSkuService.list(new QueryWrapper<WareSkuEntity>().eq("sku_id", id)));
    }
}
